...
return [
    ...
    'notifications' => [
        ...
        'notifications' => [
            \Spatie\UptimeMonitor\Notifications\Notifications\UptimeCheckFailed::class => ['email'],
            \Spatie\UptimeMonitor\Notifications\Notifications\UptimeCheckRecovered::class => ['email'],
        ...
        'mail' => [
            'to' => [env('MONITOR_CHECK_RECIPIENT')],
        ],
