...
__webpack_require__(/*! ./jqueryMenus */ "./resources/js/jqueryMenus.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.prop-environment-form').children().length <= 1) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.prop-environment-form').find('.prop-environment-form__remove').css('display', 'none');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".prop-environment-form div:first-child").find(".prop-environment-form__remove").css('display', 'inline-block');
  }

  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".prop-environment-form__add").on("click", function (e) {
    e.preventDefault();
    propEnvironmentCount = propEnvironmentCount + 1;
    var mainsection = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".prop-environment-form");
    var submainsec = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>", {
      'id': "prop-environmnet-form__entry-" + propEnvironmentCount
    });
    mainsection.append(submainsec);
    submainsec.append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<p>", {
      'text': "Environment " + propEnvironmentCount
    })).append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<label>", {
      'text': "Type:"
    })).append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<input>", {
      'type': "text",
      'name': "env_types[".concat(propEnvironmentCount, "]")
    })).append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<label>", {
      'text': "Server:"
    })).append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<input>", {
      'type': "text",
      'name': "env_servers[".concat(propEnvironmentCount, "]")
    })).append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<label>", {
      'text': "URL:"
    })).append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<input>", {
      'type': "text",
      'name': "env_urls[".concat(propEnvironmentCount, "]")
    }));
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".prop-environment-form__remove").on("click", "", function (e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#prop-environmnet-form__entry-".concat(propEnvironmentCount)).remove();
    propEnvironmentCount = propEnvironmentCount - 1;
  });
});
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var formstone_src_js_navigation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! formstone/src/js/navigation */ "./node_modules/formstone/src/js/navigation.js");
/* harmony import */ var formstone_src_js_navigation__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(formstone_src_js_navigation__WEBPACK_IMPORTED_MODULE_1__);
